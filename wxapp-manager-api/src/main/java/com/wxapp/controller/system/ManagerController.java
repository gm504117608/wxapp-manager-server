...
public class ManagerController extends BaseController {
    ...
    public Response register(@RequestBody ManagerDTO managerDTO) {
        ...
        return success(managerService.insertManager(managerDTO2ManagerDO(managerDTO)));
    }
    ...
    public Response updateManager(ManagerDTO managerDTO) {
        return success(managerService.updateManager(managerDTO2ManagerDO(managerDTO)));
    }
